...
import os
if "bateau_full_4" not in os.listdir("./RealTimeMOT/YoloV8/Train15") :
  os.mkdir("./RealTimeMOT/YoloV8/Train15/bateau_full_4")
  os.mkdir("./RealTimeMOT/YoloV8/Train15/bateau_full_4/det")
  os.mkdir("./RealTimeMOT/YoloV8/Train15/bateau_full_4/img1")

if "output" not in os.listdir("./RealTimeMOT/YoloV8/Train15") :
  os.mkdir("./RealTimeMOT/YoloV8/Train15/output")

det = open("./RealTimeMOT/YoloV8/Train15/bateau_full_4/det/det.txt","w")
det.close()
...
#vs = cv2.VideoCapture("./inputVideos/bateau/bateau_full_4.mp4")
...
seq = open("./RealTimeMOT/YoloV8/Train15/bateau_full_4/seqinfo.ini","w")
seq.write("[Sequence]\nname=bateau_full_4\nimDir=img1")
seq.close()
...
try:
	...
	seq = open("./RealTimeMOT/YoloV8/Train15/bateau_full_4/seqinfo.ini","a")
...
while acc < total :
  ...
  if grabbed:
    ...
    cv2.imwrite("./RealTimeMOT/YoloV8/Train15/bateau_full_4/img1/"+zeros[:i-len(str(acc))]+str(acc)+".jpg", frame)
    ...
    for box in boxes:
      ...
      if box[-2] > CONF_TRESHOLD :
          ...
          det = open("./RealTimeMOT/YoloV8/Train15/bateau_full_4/det/det.txt","a")
    ...
    if writer is None:
      ...
      writer = cv2.VideoWriter('./RealTimeMOT/YoloV8/Train15/output/detections_bateau_full_4.avi', fourcc=fourcc, fps=fps,
